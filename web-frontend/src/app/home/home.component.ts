...
export class HomeComponent implements OnInit, AfterContentInit {
  ...
  @ViewChild('editPostComponent') editPostComponent?: EditPostComponent;
  ...
  setRoute(): void {
    setRoute(this.generalStateStore, 'Home', 'home', ['Home', 'Dashboard']);
  }
  ...
  editPost(post: Post): void {
    this.editPostComponent?.toggleModal(post);
  }
